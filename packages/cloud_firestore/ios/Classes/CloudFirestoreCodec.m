...
- (FlutterMethodCall*)decodeMethodCall:(NSData*)message {
  ...
  NSAssert([value1 isKindOfClass:[NSString class]],
           @"Corrupted Firebase/Cloud Firestore method call");
...
- (void)writeValue:(id)value {
    ...
    NSDate* date = value;
    NSNumber* microsecondNumber =
        [NSNumber numberWithDouble:[date timeIntervalSince1970] * 1000 * 1000];
...
- (id)readValue {
  ...
  switch (field) {
    ...
    case CloudFirestoreFieldFloat64Data:
      return [self
          readTypedDataOfType:[CloudFirestoreCodecHelper flutterStandardDataTypeForField:field]];
